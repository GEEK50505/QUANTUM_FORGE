    ...
    def run_cycle() -> Dict[str, Any]:
        ...
        if best_key:
            try:
                ...
                vscode_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(BASE_DIR))), ".vscode")
                ...
                settings["rooscode.apiKey"] = best_key
                # Also set key for Continue extension
                settings["continue.openrouter.apiKey"] = best_key
